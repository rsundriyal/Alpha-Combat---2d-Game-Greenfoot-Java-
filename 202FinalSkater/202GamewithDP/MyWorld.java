...
public class MyWorld extends World
{
    ...
    public MyWorld()
    {
        ...
        //Greenfoot.playSound("skyfighter.mp3");
        lives = 3;
        laser = 2;
        speed = 48;
        pause = false;
    ...
    public void chanceToBackground()
    {
       ...
       {
         addObject(new Background(), 50,0);
          component.addChild(backGround);
       }
       if(Greenfoot.getRandomNumber(50)==1)
       {
         addObject(new Background(), 750, 0);
          component.addChild(backGround);
       }
    }
    public void chanceToVehicle()
    {
       ...
       if(Greenfoot.getRandomNumber(50)<1)
       {
          addObject(new Blockers(),175+Greenfoot.getRandomNumber(500), 0);
    ...
    public void chanceToBonus()
    {
       ...
       {
          addObject(new Coin(),170+Greenfoot.getRandomNumber(500), 0);
       ...
       {
          addObject(new LifeSaver(), 170+Greenfoot.getRandomNumber(500), 0);

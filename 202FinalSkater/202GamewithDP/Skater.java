...
public class Skater extends Actor
{
    ...
    GifImage mygif = new GifImage( "newchar.gif" );
     public Skater(){
    ...
    public void createBomb()
    {
       ...
       AmmoFactory ammoFactory= new AmmoFactory();       
          if(counter == 0)
          {
             ...
             {
                 AmmoFactory am = new AmmoFactory();
                Ammunition bullet = am.getAmmunition("Bullet");
                getWorld().addObject(new Bullet(),getX(),getY()-80);
                counter = 50;
             }
             if (Greenfoot.isKeyDown("A"))
             {
                 if(((MyWorld) getWorld()).getLaser()>0){
                      AmmoFactory am = new AmmoFactory();
              Ammunition bullet = am.getAmmunition("Laser");
                getWorld().addObject(new Laser(),getX(),getY()-80);
